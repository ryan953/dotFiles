...
init () {
  ...
  copy_file "$(pwd)/templates/.tmux/version_2.3_to_3.0.conf" "$HOME/.tmux/version_2.3_to_3.0.conf"
  copy_file "$(pwd)/templates/.tmux/version_3.5_up.conf" "$HOME/.tmux/version_3.5_up.conf"
